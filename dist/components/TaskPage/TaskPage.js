...
import {taskIsInWorkspaceStateFamily, taskStateFamily} from "../../atoms.js";
...
const TaskPage = ({match}) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    className: "TaskPage"
  }, /* @__PURE__ */ React.createElement("h1", null, taskIsInWorkspace ? name : "Task not found"), taskIsInWorkspace && /* @__PURE__ */ React.createElement("label", null, "Priority:", " ", /* @__PURE__ */ React.createElement("select", {
    value: priority ?? "",
    onChange: (event) => {
