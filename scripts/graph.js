import { squaredDistance, getBoxCenter, getExpandedBox, getOffsetBox, intersectLineBox, } from "./geometry.js";
import { getElementById, removeFromArray, snap, querySelector, } from "./misc.js";
    ...
    graphContainer.onpointerdown = (event) => {
        ...
        if (event.shiftKey || linkModeCheckbox.checked) {
            ...
            function onPointerMove(event) {
                ...
                if (squaredDistance(initialPosition, currentPosition) >
